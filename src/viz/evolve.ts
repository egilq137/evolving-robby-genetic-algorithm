// TEMP exploration page (increment 6.3). Drives the REAL genetic algorithm one
// generation at a time so we can:
//   - advance evolution in +1 / +10 / +100 generation steps and watch a live
//     replica of the book's Figure 9.6 (best fitness vs generation) draw itself;
//   - trace any strategy (Manual M, the current champion, best-ever, a random
//     walk, ...) over a full 200-step cleaning session on a grid;
